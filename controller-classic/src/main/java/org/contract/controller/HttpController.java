...
public class HttpController implements Controller {
    ...
    private final static Logger log = LogManager.getLogger(HttpController.class);
    ...
    public void start() throws InterruptedException {
        this.httpServer = new HttpServer(new ControllerDispatch(route), Integer.valueOf(config.getConfig().get("controller.port")));
